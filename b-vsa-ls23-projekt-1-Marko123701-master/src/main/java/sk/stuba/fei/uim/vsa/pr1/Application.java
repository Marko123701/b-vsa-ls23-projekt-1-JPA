...
public class Application extends AbstractThesisService<Student ,Educator ,FinalThesis>{
    ...
    public Student createStudent(Long aisId, String name, String email) {
        ...
        try {
            ...
            student.setSemesterOfStudy(1);
            student.setStudyProgram("default");
            em.persist(student);
            tx.commit();
            return student;
        } catch (Exception e) {
    ...
    public Student deleteStudent(Long id) {
        ...
        if (finalThesis != null) {
            finalThesis.setStatus(Status.FREE);
    ...
    public FinalThesis makeThesisAssignment(Long supervisor, String title, String type, String description) {
        ...
        finalThesis.setWorkplace(workplace);
    ...
    public FinalThesis assignThesis(Long thesisId, Long studentId) {
        ...
        if (!thesis.getStatus().equals(Status.FREE)) {
            return null;
        }
        ...
        thesis.setStatus(Status.INPROGRESS);
    ...
    public FinalThesis submitThesis(Long thesisId) {
        ...
        if (thesis.getStatus() == Status.SUBMITTED || thesis.getStatus() == Status.FREE) {
            return null;
        }
